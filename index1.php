  ...
  <div class="container"> <a class="navbar-brand navbar-logo" href="#"> <img src="images/logo.png" alt="logo" class="logo-1"> </a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item"> <a class="nav-link" href="index2.php" >Signup</a> </li>
      </ul>
    </div>
  </div>
</nav>
      ...
      <div class="row">
        <div class="col-md-8 col-sm-12">
          <div class="banner-text">
            ...
            <h6 class="white">This awesome template designed by Syed Sheraz and their Team</h6>
      ...
      <div class="video-popup">
        <div class="video-src">
          <div class="iframe-src">
            <iframe src="https://youtu.be/fRJ03btNsao?si=_ZN5kxZmup_3Fpu0?&amp;showinfo=0" allowfullscreen></iframe>
          </div>
        </div>
      </div>
    </div>
          ...
          <div class="row">
            <div class="col-md-4">
              <div class="team-detail wow bounce" data-wow-delay="0.2s"> <img src="images/user1.jpg" class="img-fluid"/>
                <h4>Syed Sheraz Amjad</h4>
                <p>Amazon VA & Programmer</p>
              </div>
            </div>
            <div class="col-md-4">
            ...
            <div class="col-md-4">
              <div class="team-detail wow bounce" data-wow-delay="0.2s"> <img src="images/user4.jpg" class="img-fluid"/>
                <h4>Ammad Ali</h4>
                <p>Video Editor</p>
              </div>
          </div>
          ...
          <div class="offset-md-2 col-md-8 col-sm-12">
            <div class="slider">
              <div class="slider-item">
                ...
                <div class="test-text"><span class="title"><span>Syed Sheraz Amjad</span> Amazon VA</span> Consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam eratvo lutpat.</div>
              </div>
              <div class="slider-item">
                <div class="test-img"><img src="images/user3.jpg" alt="Placeholder" width="157" height="157"></div>
                <div class="test-text"><span class="title"><span>Saqib Aqeel</span> Developer</span> Euismod tincidunt ut laoreet dolore magna aliquam eratvo lutpat. Ut wisi enim ad minim veniam, quis nostrud v</div>
              </div>
              <div class="slider-item">
                <div class="test-img"><img src="images/user2.jpg" alt="Placeholder" width="157" height="157"></div>
                <div class="test-text"><span class="title"><span>Faheel Butt</span> Android Developer</span> Consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam eratvo lutpat. Ut wisi enim ad minim veniam, quis nostrud v</div>
              </div>
              <div class="slider-item">
                <div class="test-img"><img src="images/user4.jpg" alt="Placeholder" width="157" height="157"></div>
                <div class="test-text"><span class="title"><span>Ammad Ali</span> Video Editor</span> Consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam eratvo lutpat. Ut wisi enim ad minim veniam, quis nostrud v</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="section-content">
          <div class="row">
            ...
            <form id="contact_form"  action="">
                ...
                <button class="btn-grad w-100 text-uppercase" name="button">Submit</button>
              </form>
            </div>
              ...
              <div class="contact-info white">
                <div class="contact-item media"> <i class="fa fa-map-marker-alt media-left media-right-margin"></i>
                  <div class="media-body">
                    ...
                    <p class="text-uppercase">NUML Lahore</p>
                  </div>
                </div>
                ...
                <div class="contact-item media"> <i class="fa fa-envelope media-left media-right-margin"></i>
                  <div class="media-body">
                    ...
                    <p class="text-uppercase"><a class="text-white" href="mailto:abcdefg@gmail.com">sherazamjad933@gmail.com</a> </p>
                  </div>
                </div>
...
<footer class="footer-copy">
  <div class="container-fluid">
    <div class="row">
      <div class="col-md-12">
        <p>2018 &copy; Applight. Website Designed by Sheraz and their team</p>
      </div>
    </div>
  </div>
</footer>
